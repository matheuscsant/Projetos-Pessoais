...
public class Utils {
  ...
  private static DateTimeFormatter dtf = DateTimeFormatter.ofPattern("dd/MM/yyyy").withZone(ZoneId.systemDefault());
  private static NumberFormat nf = new DecimalFormat("R$ #,##0.00", new DecimalFormatSymbols(new Locale("pt", "BR")));
  ...
  /**
   * @param data valor em date para ser convertido em string (dd/MM/yyyy)
  ...
  /**
   * @param valor transforma valor de String para Double (R$ 2.000,0 -> 2000,0)
   * @return Double
   */
  ...
  /**
   * @param cpf String com cpf não formatado ###########
  ...
  /**
   * @param cnpj String com cnpj não formatado ##############

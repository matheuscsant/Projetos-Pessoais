...
import br.com.cursoudemy.model.Produto;
...
public class Mercado {
  ...
  private static void listarProdutos() {
    if (Mercado.produtos.size() > 0) {
      ...
      // Mercado.produtos.forEach(p -> System.out.println(p)); -> Expressão lambda
      // Mercado.produtos.forEach(System.out::println); -> Method Reference
  ...
  private static void cadastrarProduto() {
    ...
    Utils.pausar(2);
    Mercado.teclado.nextLine(); // Resolve erro de passar direto e NumberFormatException
    Mercado.menu();
  }
